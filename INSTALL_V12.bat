...
REM echo 	7) Lotus NOTES V9 et Patch, installation depuis NAS 100.94   									REM Ne plus faire 
echo 	8) Solidedge2D, installation depuis NAS 100.94
echo 	9) Office 365, installation depuis NAS 100.94
echo 	10) DESKTOPinfo 
REM echo 	11) BIGFIX, installation depuis NAS 100.94                                                      REM Ne pas faire 
...
CMD /c net use o: \\fr-gr-app03\SEFlex\Program\ /user:\lappmuller\administrateur%Lmg@Olfex$83.com
CMD /c net use p: \\fr-gr-fs01\Groups$\ /user:\lappmuller\administrateur%Lmg@Olfex$83.com
CMD /c net use T: \\fr-gr-fs01 /user:\lappmuller\administrateur%Lmg@Olfex$83.com
